...
// Arrow functions lexically bind the value of this. It is very likely that you do not know what 
// that sentence means. And that's OK.
...
var foot = {
  kick: function () {
    ...
    foot.kick();
// ()=> passes the this without having to set and event binding 